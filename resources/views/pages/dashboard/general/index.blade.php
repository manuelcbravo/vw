<x-app-layout :active="$active">
    <x-layout.page>
        ...
        <x-slot name="cuerpo">
            ...
            <div class="card my-4">
                <div class="card-body">
                    <div class="my-4" id="chart-encuestas" style="height: 18rem;"></div>
                </div>
            </div>
            <div class="card my-4">
                <div class="card-body">
                    <div class="" id="chart-sucursales" style="height: 18rem;"></div>
                </div>
            </div>
            ...
            markers.forEach(function(markerInfo) {
                ...
                const grafica_dash1 = () => {
                    var options = {
                        ...
                        var chart = new ApexCharts(document.querySelector("#chart-encuestas"), options);
                        chart.render();   
                }
                ...
                const grafica_dash2 = () => {
                    var options = {
                        title: {
                            text: 'Calilficación por sucursal'
                        },
                        series: [{
                        name: 'Encuestas',
                        data: [44, 55, 57, 56, 61, 58, 63, 60, 66]
                        ...
                        var chart = new ApexCharts(document.querySelector("#chart-sucursales"), options);
                        chart.render();   
                }
                ...
                HSCallGet.init('{{ url('dashboardG')}}/2/' +startDate +'/' + endDate,get)
