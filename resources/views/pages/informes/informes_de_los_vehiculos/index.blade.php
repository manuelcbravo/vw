<x-app-layout :active="$active">
    <x-layout.page>
        ...
        <x-slot name="modals">
            @include('pages.blog.categorias.modal_add')
        </x-slot>
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                columns: [{
                    render: function (data, type, row) {
                        ...
                        return `<button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal" data-bs-target="#ModalCategoria" data-url="{{ url('categorias') }}/${row.id}/edit">
                                    <i class="bi-pencil-fill text-info"></i>
                                </button>
                                <button type="button" class="btn btn-white btn-sm rmv" data-id="${row.id}" data-url="{{ url('categorias') }}/${row.id}">
