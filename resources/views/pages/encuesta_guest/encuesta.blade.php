...
<html lang="en" dir="">
	...
	<head>
        ...
        <style>
            ...
            .wizard-step2.completed {
                background-color: #ffba00; /* Color para los pasos completados */
                color: #fff;
            }
		...
		<main id="content" role="main" >
			...
			<div class="container content-space-1 content-space-b-lg-2">
                {{-- <form class="js-validate needs-validation" novalidate="" data-name="FormUsuarios" id="FormUsuarios" method="POST" >  --}}
                    <div class="w-lg-75 mx-lg-auto" id="wizard-inicio" >
                        <div class="d-grid gap-10">
                            <div class="d-grid gap-2 text-center">
                                <h1 class="text-white" style="font-size: 2.5rem">BIENVENID@</h1>
                                <img class="avatar avatar-xl avatar-4x3 mx-auto" src="../{{ ENV('APP_LOGO') }}" alt="Logo">
                                <h2 class="text-white">SUCURSAL: PALOMAS</h2>
                                <h4 class="text-white mt-3">Gracias por brindarnos sus comentarios para mejorar nuestro servicio.</h4>
                                <div class="text-center my-4">
                                    <button id="btn_inicio" class="btn text-white rounded-pill p-3" style="background-color: #ea5731ff; font-size: 1.2rem">INICIAR</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-lg-75 mx-5">
                        <div class="wizard-progress" style="display: none">
                            <div class="wizard-step2 completed"></div>
                            <div class="wizard-step2" id="wizard-pill-2"></div>
                            <div class="wizard-step2" id="wizard-pill-3"></div>
                            <div class="wizard-step2" id="wizard-pill-4"></div>
                            <div class="wizard-step2" id="wizard-pill-5"></div>
                            <div class="wizard-step2" id="wizard-pill-6"></div>
                        </div>

                        <div id="wizard-step-1" class="wizard-step" style="display: none">

                            <h5 class="text-white mt-3">1. ¿Qué le pareció el servicio de la sucursal?</h5>
                            <div class="mb-4">
                                <div class="row my-3">
                        ...
                        <div id="wizard-step-2" class="wizard-step" style="display: none">
                            ...
                            <h5 class="text-white mt-3">2. ¿Nuestro personal fue amable con usted?</h5>
                        ...
                        <div id="wizard-step-3" class="wizard-step" style="display: none">
                            <h5 class="text-white mt-3">3. ¿Qué le pareció el sabor de nuestros alimentos?</h5>
                            <div class="mb-4">
                                <div class="row my-3">
                                    <div class="col-3 text-center">
                                        <img class="image-slide" src="{{ asset('_assets') }}/img/pasteko/multiple1.png" alt="Logo">
                        ...
                        <div id="wizard-step-4" class="wizard-step" style="display: none">
                            <h5 class="text-white mt-3">4. ¿Al hacer su pedido, el personal le invitó a probar algún producto?</h5>
                            <div class="my-4 d-flex justify-content-center align-items-center">
                                <div class="radio-container text-center mx-5">
                        ...
                        <div id="wizard-step-5" class="wizard-step" style="display: none">
                            <h5 class="text-white mt-3">5. ¿Como calificaría la limpieza e higiene de la sucursal?</h5>
                            <div class="mb-4">
                                <div class="row my-3">
                                    <div class="col-3 text-center">
                                        <img class="image-slide" src="{{ asset('_assets') }}/img/pasteko/multiple1.png" alt="Logo">
                        ...
                        <div id="wizard-step-6" class="wizard-step" style="display: none">
                            ...
                            <h5 class="text-white mt-3">Muchas gracias por sus comentarios, en <img  src="../{{ ENV('APP_LOGO') }}" alt="Logo2" style="height: 1.2em; vertical-align: middle;"> siempre estamos comprometido con la calidad</h5>
                            <div class="mb-4">
                            ...
                            <div class="d-grid mb-2">
                                <button type="submit" class="btn text-white rounded-pill" style="background-color: #ea5731ff;">Terminar</button>
                            </div>
                        </div>
                        <div id="wizard-navigation" class="text-center mt-8 justify-content-between align-items-center" style="bottom: 0; width: 100%;display: none;">
                            <div class="text-center">
                                <img class="avatar avatar-xl avatar-4x3 mx-auto" src="../{{ ENV('APP_LOGO') }}" alt="Logo">
                            </div>
                            <button id="next-step" class="btn text-white rounded-pill" style="background-color: #ea5731ff">
		...
		<script>
			(function() {
                ...
                $('#next-step').click(function() {
                    if (currentStep < 6) {
                        currentStep++;
                        $("#wizard-pill-"+currentStep).addClass('completed');
                        updateStepDisplay();
                    }
                    
                    if(currentStep == 6){
                        $("#wizard-navigation").hide()
                        $('#wizard-navigation').removeClass("d-flex")
                ...
                $('#btn_inicio').click(function() {
                    $('#wizard-inicio').hide();
                    $('.wizard-progress, #wizard-step-1, #wizard-navigation').show()
                    $('#wizard-navigation').addClass("d-flex")
                });

                // Función para actualizar la visualización del paso actual
